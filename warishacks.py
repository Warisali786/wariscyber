...
def login():
	...
	try:
		...
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mIt looks like your account has an error disabled...")
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;96m[!] \033[1;91mIt looks like your account has an error disabled..."
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
		print"\033[1;96m[!] \x1b[1;91mYour account is not responding perfectly..."
		keluar()
	os.system("clear")
	print logo
	print 42*"\033[1;96m="
	...
	print "\x1b[1;96m[\x1b[1;92m2\x1b[1;96m]\x1b[1;93m Clone groups Lists               "
	print "\x1b[1;96m[\x1b[1;92m3\x1b[1;96m]\x1b[1;93m Yahoo cloning               "
